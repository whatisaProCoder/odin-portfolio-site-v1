...
function WorkSection() {
  const [uptilID, setUptilID] = useState(9);
  ...
  return (
    <>
      ...
      {uptilID != Projects.length - 1 ? (
        <div
          className="mt-8 mb-12 text-md text-center text-[#c2c2c2] hover:text-[#3390f3] cursor-pointer select-none inter font-semibold"
